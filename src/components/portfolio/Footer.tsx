...
const Footer = () => {
  return (
    <footer id="contact" className="flex h-svh shrink-0 snap-start snap-always flex-col overflow-hidden bg-black text-white px-5 pt-20 pb-3 sm:px-8 sm:pt-28 lg:h-dvh lg:px-10">
